...
-- Source: 042_add_cable_snapshot.up.sql.bak
...
BEGIN
    IF to_regclass('job_cables') IS NULL THEN
        RAISE NOTICE 'job_cables relation not found; skipping migration 042_add_cable_snapshot.up';
    ELSE
        ...
        RAISE NOTICE 'Applied migration 042_add_cable_snapshot.up';
    END IF;
END$$;
